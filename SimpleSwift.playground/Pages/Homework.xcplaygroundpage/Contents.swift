...
func counter(_ args: [String]) -> Int{
    return args.count - 1
}

func avg(_ args: [String]) ->Int{
    if args.count == 1{
        return 0
    }
    var x = 0
...
func calculate(_ arg: String) -> Int {
    ...
    let substring = arg.split(separator: " ")
    for s in substring{
        argArray.append(String(s))
    }
...
//: 
//: This is worth 1 pt
func counter(_ args: [String]) -> Double{
